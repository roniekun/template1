...
const Header = () => {
  ...
  return (
    <motion.header 
        ...
        className={`w-screen opacity-0 fixed z-20 top-0 ${isScrolled ? 'transform bg-blend-difference -translate-y-full' : ''}  transition  justify-center items-center flex bg-transparent  h-14 md:h-16`}>
