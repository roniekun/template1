    ...
    <PageAnimator>
      <motion.main 
        ...
        <div className='border-zinc-700 w-full mt-16 my-5 flex flex-col gap-2'>
             <h1 className='lg:text-3xl md:text-2xl  text-2xl uppercase font-bold'>
             YourStudio specializes in brand strategy &
              visual identity.</h1>
            <p className='md:w-1/2 p-1 text-base leading-snug'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo earum sint,
        ...
        <h1 className='capitalize text-xl font-bold'>--Projects--</h1>
            <Cards /> 
        </div>
        </section>
        ...
        <h1
        className='text-left h-fit md:text-xl text-lg w-full capitalize p-1 font-bold'
