  ...
  return (
    ...
    <div key={index}
        onClick={()=>handleClick(index)}
         className='flex group  flex-col w-full h-[700px] lg:w-[45vw] lg:h-[800px] md:h-[800px] gap-5 relative border border-black  cursor-pointer'>
        <img className='w-11/12 h-5/6 relative border group-hover:shadow-xl border-zinc-400 self-center object-cover' 
        src="" alt="thumbnail" />
